...
// Filter routes by origin city for REGULAR FARES
export const DELHI_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
  (route) => route.origin === "Delhi",
);

// Filter routes by origin city for REGULAR FARES
export const NOIDA_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
  (route) => route.origin === "Noida",
);

export const GURUGRAM_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
  (route) => route.origin === "Gurugram",
);

export const FARIDABAD_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
  (route) => route.origin === "Faridabad",
);

export const GHAZIABAD_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
...
export const HYDERABAD_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
  (route) => route.origin === "Hyderabad",
);

export const LUDHIANA_FARE_ROUTES: TaxiRoute[] = ROUTES.filter(
