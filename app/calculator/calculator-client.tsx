        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full border border-primary/20">
              ...
              <span className="text-xs font-black uppercase text-primary tracking-widest text-[10px]">
                Instant Fare Check
              </span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black text-secondary tracking-tight">
              Tempo Traveller{" "}
              <span className="text-primary italic">Fare Calculator</span>
            </h1>
            <p className="text-slate-500 max-w-lg mx-auto font-medium">
              Calculate the exact fixed fare for your group trip in seconds. No
          ...
          <div className="grid md:grid-cols-5 gap-8 items-start">
            <Card className="md:col-span-3 p-8 shadow-xl border-border bg-white space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-black text-secondary uppercase tracking-wider">
                    Estimated Distance
                  </label>
                  ...
                  {vehicleTypes.map((type) => (
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <div
                          className={`p-2 rounded-lg ${vehicleSize === type.rate ? "bg-primary text-white" : "bg-slate-50 text-slate-400"}`}
                        >
            ...
            <Card className="md:col-span-2 p-8 shadow-2xl bg-secondary text-white space-y-8 relative overflow-hidden border-none text-center">
              ...
              <div className="relative z-10 space-y-6">
                <p className="text-primary font-black uppercase text-xs tracking-[0.2em] italic">
                  Your Estimated Fare
                </p>
                ...
                <div className="space-y-4">
                  <Button
                    className="w-full h-14 text-lg font-bold gap-3 rounded-xl shadow-lg shadow-primary/20"
          ...
          <div className="mt-20 max-w-2xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-xl font-black text-secondary uppercase tracking-tight italic">
                Why Fixed Pricing?
              </h2>
              <div className="h-px bg-slate-200 flex-1" />
            </div>
            <p className="text-center text-slate-600 leading-relaxed text-sm font-medium">
              At YatraTempoTraveller, we believe in radical transparency. Most
              offline travel agents in Varanasi give vague estimates. Our
              calculator uses real-time distance metrics and vehicle utility
              rates to give you a quote that won&apos;t change after you book.
            </p>
          </div>

          <FAQSection
            faqs={GLOBAL_FAQS}
            title="Fare Calculation & Booking FAQs"
          />
        </div>
      </div>
