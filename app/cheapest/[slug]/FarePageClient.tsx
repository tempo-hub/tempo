...
export default function FarePageClient({
  ...
  const whatsappUrl = `https://wa.me/919151827941?text=${encodeURIComponent(
          ...
          >
            <div className="max-w-5xl mx-auto px-4">
              ...
              <p className="text-sm sm:text-base text-muted-foreground my-4 leading-relaxed">
                ...
                {route.destination} without compromising on comfort and safety.
                We offer budget-friendly pricing with clean vehicles,
                experienced drivers, and transparent charges for every trip.
                Choose from 9 seater, 12 seater, 15 seater, 16 seater, 20
                seater, 26 seater and group travel options perfect for family
                tours, pilgrimages, weddings, and corporate journeys. Our lowest
                fare packages are designed to give maximum value with reliable
                service and no hidden costs. Compare all affordable options and
                book your {route.origin} to {route.destination} tempo traveller
                at the best cheapest price today.
              </p>
          ...
          <section className="py-16 bg-slate-50">
            <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="text-center mt-8">
                <button
                  onClick={() => setIsBookingOpen(true)}
                  className="inline-flex items-center gap-2 text-primary font-bold hover:underline cursor-pointer"
                >
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4">
              <h2 className="text-3xl font-black text-center mb-8">
                {route.origin} to {route.destination} Tempo Traveller Pricing
                (Per k.m)
              </h2>
          ...
          <section className="bg-gradient-to-r from-red-500 to-orange-500 text-white py-12">
            <div className="max-w-7xl mx-auto px-4 text-center">
              ...
              <button
                ...
                aria-label={`Book ${route.origin} to ${route.destination} at ₹${fare}`}
              >
