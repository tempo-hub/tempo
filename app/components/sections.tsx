        ...
        {[
          {
            icon: Search,
            title: "1. Check Fare",
            desc: "Select your route and tempo traveller size on our calculator to see the fixed price.",
          },
          {
            icon: PhoneCall,
            title: "2. WhatsApp Us",
            desc: "Click the book button to share your group trip details with our team instantly.",
          },
          {
            icon: CalendarCheck,
            title: "3. Get Confirmation",
            desc: "Receive driver and tempo traveller details 4 hours before your journey starts.",
          },
        ].map((step, i) => (
          <div
            key={i}
          ...
          >
            {i < 2 && (
              <div className="hidden lg:block absolute top-10 -right-1/4 w-1/2 h-px border-t-2 border-dashed border-slate-200" />
            )}
...
export const SafetySection = ({ origin = "Varanasi" }: { origin?: string }) => (
      ...
      <div className="grid lg:grid-cols-2 gap-20 items-center">
        <div className="space-y-8">
          ...
          <h2 className="text-4xl font-black leading-tight">
            Your Search for a Reliable <br />
            <span className="text-primary italic">
              {origin} Tempo Traveller Ends Here.
            </span>
          </h2>
          <p className="text-slate-400 text-lg">
            We don&apos;t just provide vehicles; we provide peace of mind. Every
            group trip is monitored for safety and punctuality.
          </p>
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              {
                title: "Background Checks",
                desc: "Every driver is local and police verified with zero criminal record.",
              },
              {
                title: "Real-time Tracking",
                desc: `All our tempo travellers are GPS enabled and tracked from our local office in ${origin}.`,
              },
              {
                title: "No Sleepy Drivers",
                desc: "Strict 10-hour daily driving limit to ensure driver alertness.",
              },
              {
                title: "Direct Contact",
                desc: "Direct access to our 24/7 emergency support helpline.",
              },
            ].map((item, i) => (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-bold">
                  {origin.substring(0, 3).toUpperCase()}-AYO,{" "}
                  {origin.substring(0, 3).toUpperCase()}-PRY
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <p className="text-slate-600 leading-relaxed text-lg">
            We aren&apos;t just an app. We are a locally registered business
            with a physical presence and tempo traveller garage in the heart of{" "}
            {origin}. Visit us for tea and bookings!
          </p>
          <div className="space-y-4">
            <div className="flex gap-4 items-start p-6 bg-white rounded-2xl border border-border shadow-sm">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  YatraTempoTraveller.com, Main Road Office, Central Location,{" "}
                  {origin}, UP
                </p>
              </div>
            </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
    {[
      { icon: Fuel, title: "Fuel Charges", detail: "Included in base price" },
      {
        ...
        detail: "Day/Night allowance included",
      },
      {
        icon: ShieldCheck,
        title: "GST (5%)",
        detail: "No extra tax on portal",
      },
      {
        icon: ThumbsUp,
        title: "Clean Vehicle",
        detail: "Sanitized before pickup",
      },
    ].map((item, i) => (
      <div
        key={i}
  ...
  <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-start">
    ...
    <div className="space-y-2 min-w-0">
      <h4 className="font-bold text-amber-900">
        What is NOT included in this fare?
      </h4>
      <p className="text-sm text-amber-800 leading-relaxed">
        To keep our fares the lowest in {origin}, we don&apos;t include variable
        costs like{" "}
        <span className="font-bold">
          Toll Taxes, State Entry Taxes, and Parking Fees
        </span>
        . These must be paid by the customer directly at the toll plazas or
        added to the final bill at actuals.
      </p>
    ...
    <div className="max-w-4xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
      <div>
        <h2 className="text-3xl font-black text-secondary mb-6">
          Why Our Tempo Traveller Fare is Cheaper & More Transparent?
        </h2>
        <div className="space-y-6">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Unlike other apps that take 25%, we charge owners a flat fee of
                ₹500. This saving is passed directly to your group.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h4 className="font-bold text-secondary">
                {origin} Local Expertise
              </h4>
              <p className="text-sm text-muted-foreground">
                We aren&apos;t a tech company in Bangalore; we are based locally
                in {origin}. We know every shortcut and toll.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                The price you see is what your group pays. No hidden service
                taxes or &quot;advance booking&quot; confusion.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-secondary p-8 rounded-3xl text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <span className="text-primary font-black text-4xl mb-4 block italic">
            &quot;Perfect for Groups&quot;
          </span>
          <p className="text-slate-300 italic mb-8">
            &quot;Our 20-person pilgrim group saved ₹5,000 on our {origin} to
            Ayodhya trip compared to booking two separate taxis. The 24 seater
            was spacious and the driver was excellent.&quot;
          </p>
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {[
          ...
          {
            icon: MapPin,
            title: `${origin.substring(0, 3).toUpperCase()} Local`,
            desc: "Expert drivers",
          },
        ].map((item, i) => (
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          <h2 className="text-4xl font-extrabold text-secondary tracking-tight">
            {origin}&apos;s Homegrown <br />
            <span className="text-primary italic">Tempo Traveller Experts</span>
          </h2>
          <p className="text-lg text-slate-600 leading-relaxed">
            Started as a small local transport service, YatraTempoTraveller has
            grown into {origin}&apos;s most trusted tempo traveller provider. We
            understand the unique needs of groups visiting from {origin} to
            various religious and tourist destinations.
          </p>
          <div className="space-y-4">
            {[
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="text-center mb-16 space-y-4">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          Verified experiences from groups who booked their tempo traveller from{" "}
          {origin} with us.
        </p>
      </div>
      <div className="grid md:grid-cols-3 gap-8">
        {[
          {
            name: "Rajesh Kumar",
            role: `Pilgrim Group from ${origin}`,
            text: `Booked a 15 seater tempo traveller for our ${origin} to Ayodhya pilgrimage. The driver was very polite. Fixed price was a huge relief.`,
            stars: 5,
          },
          {
            name: "Anjali Sharma",
            role: "Wedding Party (Mumbai)",
          ...
          <div
            key={i}
            className="p-8 border border-border rounded-3xl hover:border-primary/30 transition-all bg-slate-50/50"
          >
            <div className="flex gap-1 mb-4">
              {[...Array(t.stars)].map((_, j) => (
                <ThumbsUp key={j} className="h-4 w-4 text-primary" />
              ))}
            </div>
...
export const SocialProof = ({ origin = "Varanasi" }: { origin?: string }) => (
  <section className="bg-secondary py-20 text-white overflow-hidden relative">
    <div className="max-w-7xl mx-auto px-4 relative z-10">
      <div className="text-center space-y-6 max-w-3xl mx-auto">
        <h2 className="text-4xl font-extrabold tracking-tight">
          {origin}&apos;s Most Trusted Group Transport
        </h2>
        <p className="text-slate-400 text-lg">
          We help over 300+ groups every month travel safely from {origin} to
          different parts of UP and surrounding states.
        </p>
