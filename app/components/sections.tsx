        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
                <div className="space-y-8">
                    ...
                    <h2 className="text-4xl font-black leading-tight">Your Search for a Reliable <br /><span className="text-primary italic">{origin} Tempo Traveller Ends Here.</span></h2>
                    ...
                    <div className="grid sm:grid-cols-2 gap-8">
                        {[
                            ...
                            { title: "Real-time Tracking", desc: `All our tempo travellers are GPS enabled and tracked from our local office in ${origin}.` },
                    ...
                    <div className="h-[400px] w-full max-w-md bg-slate-800 rounded-3xl border border-white/10 shadow-3xl p-8 flex flex-col justify-center gap-6 relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="font-bold">{origin.substring(0, 3).toUpperCase()}-AYO, {origin.substring(0, 3).toUpperCase()}-PRY</span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
...
export const OfficeLocation = ({ origin = "Varanasi" }: { origin?: string }) => (
    <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-6">
                    <h2 className="text-3xl font-black text-secondary">Visit Our Local Office</h2>
                    <p className="text-slate-600 leading-relaxed text-lg">We aren&apos;t just an app. We are a locally registered business with a physical presence and tempo traveller garage in the heart of {origin}. Visit us for tea and bookings!</p>
                    <div className="space-y-4">
                        <div className="flex gap-4 items-start p-6 bg-white rounded-2xl border border-border shadow-sm">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">YatraTempoTraveller.com, Main Road Office, Central Location, {origin}, UP</p>
                            </div>
                        </div>
                        <div className="flex gap-4 items-start p-6 bg-white rounded-2xl border border-border shadow-sm">
                ...
                <div className="aspect-[16/10] bg-slate-200 rounded-3xl overflow-hidden border border-border shadow-inner flex items-center justify-center relative">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-[11px] font-bold text-secondary uppercase tracking-widest">Local Office, {origin}</p>
                    </div>
...
export const ExclusionsNotice = ({ origin = "Varanasi" }: { origin?: string }) => (
            ...
            <div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            <h4 className="font-bold text-secondary">{origin} Local Expertise</h4>
                            <p className="text-sm text-muted-foreground">We aren&apos;t a tech company in Bangalore; we are based locally in {origin}. We know every shortcut and toll.</p>
                        </div>
                    </div>
                    <div className="flex gap-4">
                        <div className="bg-white p-3 rounded-xl shadow-sm border border-border shrink-0">
        ...
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                    ...
                    { icon: MapPin, title: `${origin.substring(0, 3).toUpperCase()} Local`, desc: "Expert drivers" },
                ].map((item, i) => (
...
export const ExperienceSection = ({ origin = "Varanasi" }: { origin?: string }) => (
    <section className="py-24 bg-slate-50 border-b border-border">
        <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                    <h2 className="text-4xl font-extrabold text-secondary tracking-tight">{origin}&apos;s Homegrown <br /><span className="text-primary italic">Tempo Traveller Experts</span></h2>
                    <p className="text-lg text-slate-600 leading-relaxed">
                        Started as a small local transport service, YatraTempoTraveller has grown into {origin}&apos;s most trusted tempo traveller provider. We understand the unique needs of groups visiting from {origin} to various religious and tourist destinations.
                    </p>
                    <div className="space-y-4">
                        {[
...
export const TestimonialsSection = ({ origin = "Varanasi" }: { origin?: string }) => (
    <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16 space-y-4">
                <h2 className="text-4xl font-extrabold text-secondary tracking-tight">Real Traveler Stories</h2>
                <p className="text-muted-foreground max-w-xl mx-auto">Verified experiences from groups who booked their tempo traveller from {origin} with us.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
                {[
                    {
                        name: "Rajesh Kumar", role: `Pilgrim Group from ${origin}`,
    ...
    <section className="bg-secondary py-20 text-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center space-y-6 max-w-3xl mx-auto">
                <h2 className="text-4xl font-extrabold tracking-tight">{origin}&apos;s Most Trusted Group Transport</h2>
                <p className="text-slate-400 text-lg">We help over 300+ groups every month travel safely from {origin} to different parts of UP and surrounding states.</p>
