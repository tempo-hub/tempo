          ...
          <div className="flex-1 space-y-8">
            <div className="text-center mb-8 space-y-4">
              ...
              <div className="flex justify-center">
                <div className="inline-flex items-center gap-2 bg-green-50 px-3 py-1 rounded-full border border-green-100 shadow-sm">
                  ...
                  <span className="text-[10px] font-black uppercase text-green-700 tracking-wider font-sans">
            ...
            <div>
              <h3 className="text-2xl font-black text-secondary mb-2 flex items-center gap-2">
                <ShoppingCart className="text-primary h-6 w-6" /> Tempo
                Traveller Fare Calculator
              </h3>
              <p className="text-muted-foreground text-sm">
                Select your tempo traveller size and trip type for an instant
                fixed quote.
              </p>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {VEHICLES.map((vehicle) => (
                    ...
                    >
                      <p
                        className={`text-sm font-bold ${selectedVehicle.type === vehicle.type ? "text-primary" : "text-secondary"}`}
                      >
                        {vehicle.type}
                      </p>
