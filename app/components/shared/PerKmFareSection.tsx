    ...
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="bg-white border border-gray-200 rounded-3xl shadow-sm p-6 md:p-10">
        ...
        <p className="text-gray-700 leading-7 mb-8">
          Book affordable tempo traveller service from {fromCity} to {toCity} at
          just ₹{fare}/k.m. Clean vehicles, experienced drivers, and comfortable
          seating available for all trips.
        </p>
        ...
        <div className="mt-8">
          <a
            href={`https://wa.me/916280820037?text=Hello%20I%20want%20to%20book%20Tempo%20Traveller%20from%20${fromCity}%20to%20${toCity}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-primary text-white font-semibold px-6 py-3 rounded-xl transition"
          >
