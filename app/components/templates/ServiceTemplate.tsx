          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-5xl mx-auto">
              ...
              <p className="mt-6 text-base md:text-xl leading-relaxed text-slate-300 max-w-4xl mx-auto">
                ...
                <span className="text-primary font-bold">₹18/km</span>.
                Experience comfortable seating, verified drivers, and luxury
                travel options perfect for family trips, weddings, corporate
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <button
                        onClick={() => {
                          setSelectedVehicle(`${vehicle.seats}-Seater`);
        ...
        <section className="py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Experience comfort, safety, and reliability with our premium
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Join 5000+ satisfied customers who trust us for their travel
                needs
              </p>
            </div>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  ...
                  service offers the perfect solution for group travel. Covering
                  a distance of
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    <strong>Convenient:</strong> Door-to-door service without
                    the hassle of changing vehicles
                  </li>
                  <li>
                ...
                <p>
                  ...
                  accessible throughout the year. However, the best time to
                  travel depends on your preferences. Winter months (October to
                  March) offer pleasant weather, while summer months (April to
                  June) are suitable for early morning trips. Monsoon season
                  (July to September) brings lush greenery but requires careful
                  driving.
                </p>
